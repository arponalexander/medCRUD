...
class Medication_R02(models.Model):
    ...
    abbreviation = models.ForeignKey(Medication_R01, on_delete=models.CASCADE, max_length=200)
...
class Medication_B00(models.Model):
    ...
    medication_route_rec = models.ForeignKey(Medication_R01, max_length=200, on_delete=models.CASCADE())
    medication_frequency_rec = models.ForeignKey(Medication_R02, max_length=200, on_delete=models.CASCADE())
